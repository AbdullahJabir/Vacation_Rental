         ...
         @foreach($items as $service)
          <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
            <div class="d-block services-wrap text-center">
              ...
              <div class="img" style="background-image: url({{ asset('images/'.$service->image) }});"></div>
              <div class="media-body py-4 px-3">
                <h3 class="heading">{{$service->first_name}}</h3>
          ...
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2>Apartment Room</h2>
                ...
                <div class="row no-gutters">
                    ...
                    @foreach($ApartmentRoom as $room)
                    
                <div class="col-lg-6">
                    <div class="room-wrap d-md-flex">
                        <a href="#" class="img"style="background-image: url({{ asset('uploads/slider/'.$room->image) }});"></a>
                        <div class="half left-arrow d-flex align-items-center">
                            <div class="text p-4 p-xl-5 text-center">
                                <p class="star mb-0"><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span><span class="fa fa-star"></span></p>
                                <!-- <p class="mb-0"><span class="price mr-1">$120.00</span> <span class="per">per night</span></p> -->
                                <h3 class="mb-3"><a href="rooms.html">{{$room->room_name}}</a></h3>
